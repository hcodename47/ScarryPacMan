...
void AScarryPacManCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AScarryPacManCharacter::Look);
	}
	else
	{
...
void AScarryPacManCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
