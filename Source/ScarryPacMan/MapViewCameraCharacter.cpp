...
#include "MapViewCameraCharacter.h"
...
DEFINE_LOG_CATEGORY(LogMapCameraCharacter);

// Sets default values
AMapViewCameraCharacter::AMapViewCameraCharacter()
{
	...
	FirstPersonCameraComponent->SetRelativeRotation(FRotator(-45.f, 0.f, 0.f)); // Rotate the camera to look down
}

void AMapViewCameraCharacter::NotifyControllerChanged()
{
